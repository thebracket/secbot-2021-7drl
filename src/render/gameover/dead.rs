...
pub fn game_over_dead(ctx: &mut BTerm, ecs: &World) -> NewState {
    ...
    batch.print_color(Point::new(70, 5), "SecBot is Dead!", ColorPair::new(GOLD, BLACK));
    ...
    batch.print_color(Point::new(50, 10), format!("{} monsters died.", stats.total_hostiles_killed), bw);
    ...
    batch.print_color(Point::new(50, 23), stats.last_heard, ColorPair::new(GREEN, BLACK));
